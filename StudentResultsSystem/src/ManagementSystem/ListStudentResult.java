...
public class ListStudentResult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, 660, 160));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 454, 110, 40));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("SELECT student.name, result.* FROM student INNER JOIN result WHERE student.rollNo=result.rollNo ORDER BY result.result DESC");
